...
const DT_TASKS = {
  mild: [
    ...
    { emoji:"💪🏼", who:"any", target:"mf",  text:"Hold a plank position while {target} tries to distract you for 1 minute." },
  ...
  spicy: [
	...
	{ emoji:"🥃", who:"any", target:"mf",  text:"Body shot:  Drizzle a shot of liquor into {target}'s belly button and slurp it off." },
    { emoji:"💃", who:"f", target:"none", text:"Do a slow, flirtatious dance in front of the group for 30 seconds." },
    ...
    { emoji:"🙈", who:"any", target:"any",  text:"Let {target} blindfold you with a piece of clothing and guess who in the group touches your hand." },
  ],
	
  hot: [
    { emoji:"🫦", who:"any", target:"mf",  text:"Suck {target}'s finger for 5 seconds, maintaining eye contact." },
    { emoji:"🪴", who:"any", target:"f",  text:"Let {target} draw a heart on your back with her make-up." },
    { emoji:"💋", who:"any", target:"mf",   text:"Kiss {target} on the lips for 5 seconds." },
	{ emoji:"💋", who:"f", target:"any",   text:"Suck {target}'s lower lip for 5 seconds." },
	{ emoji:"🦶", who:"any", target:"mf",  text:"Suck on {target}'s toes until they next roll." },
    ...
    { emoji:"💪🏼", who:"any", target:"mf",  text:"Hold a plank position for 30 seconds while {target} pulls down your pants and slaps your butt." },
	...
	{ emoji:"👕", who:"m", target:"none", text:"Strip to your underpants and remain that way for the rest of the game." },
	...
	{ emoji:"🫦", who:"m", target:"f",  text:"Massage {target}'s crotch until they next roll." },
	{ emoji:"🍑", who:"any", target:"mf",  text:"Put {target} on all fours — dry-hump in doggy style for 20 seconds." },
    ...
    { emoji:"🩲", who:"any", target:"none", text:"Remove your bottoms and stay that way until your next roll." },
  ...
  extreme: [
	...
	{ emoji:"💋", who:"any", target:"mf",      text:"Kiss every inch of {target}'s naked leg — toes to crotch." },
    ...
    { emoji:"🔥", who:"any", target:"mf",     text:"Both you and {target} go fully naked for the remainder of the game." },
	...
	{ emoji:"🖐️", who:"f", target:"any",    text:"Grab the hand of {target} and hold it down your underwear and directly against your pussy for 30 seconds.  If they slipped in a finger, lick it." },
	...
	{ emoji:"👄", who:"m", target:"allF",     text:"Kiss {targets} at the same time.  All lips must press together." },
