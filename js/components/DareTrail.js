...
const DT_TASKS = {
  mild: [
    // Original dares
    { emoji:"🤸", who:"any", target:"none", text:"Do 10 press-ups without stopping." },
    ...
    { emoji:"🪑", who:"any", target:"mf",  text:"Sit on {target}'s lap for the next two rounds." },
    ...
    // New dares batch 2
    { emoji:"😉", who:"any", target:"any",  text:"Wink at {target} every time they speak for the next two rounds." },
    ...
    { emoji:"👃", who:"any", target:"any",  text:"Let {target} smell your neck and guess your perfume or cologne." },
    { emoji:"🤝", who:"any", target:"any",  text:"Give the player to your right a slow, deliberate handshake while maintaining eye contact." },
    { emoji:"🎵", who:"any", target:"mf",  text:"Let {target} choose a song — you have to sway to it with them for 20 seconds." },
    { emoji:"🤫", who:"any", target:"mf",  text:"Whisper a genuine compliment to {target} so no one else can hear it." },
  ],
  spicy: [
    // Original dares
    ...
    { emoji:"💆", who:"any", target:"mf",  text:"Give {target} a 60-second back massage under their shirt." },
    { emoji:"☝️", who:"any", target:"mf",  text:"Let {target} trace their finger slowly up your inner arm and neck for 20 seconds." },
    { emoji:"🪑", who:"any", target:"mf",  text:"Sit in {target}'s lap facing them for the next two rounds." },
    ...
    { emoji:"👗", who:"any", target:"none", text:"Unbutton or unzip one item of your own clothing and leave it that way for two rounds." },
    ...
    { emoji:"🛋️", who:"any", target:"mf",  text:"Lie with your head in {target}'s lap for the next two rounds." },
    { emoji:"🙈", who:"any", target:"any",  text:"Let {target} blindfold you with a piece of clothing and guess who touches your hand." },
    { emoji:"🍑", who:"any", target:"any",  text:"Describe {target}'s body using only food metaphors — in detail." },
  ],
  hot: [
    // Original dares
    { emoji:"🍺", who:"any", target:"none", text:"Down your drink in one — or take a shot if you dare." },
    { emoji:"🫦", who:"any", target:"mf",  text:"Suck {target}'s finger for 5 seconds." },
    ...
    // New dares
    { emoji:"😘", who:"any", target:"mf",   text:"Kiss {target} on the open mouth for 20 seconds." },
    ...
    { emoji:"🌶️", who:"any", target:"mf",  text:"Whisper the most explicit fantasy you've ever had into {target}'s ear." },
    { emoji:"🕺", who:"any", target:"mf",  text:"Grind slowly against {target} for 30 seconds." },
		{ emoji:"🍑", who:"any", target:"mf",  text:"Put {target} on all fours — dry-hump in doggy style until your next roll." },
    // New dares batch 2
    { emoji:"💋", who:"any", target:"mf",  text:"Let {target} kiss up your spine from the small of your back to your neck." },
    { emoji:"🦵", who:"any", target:"mf",  text:"Straddle {target} and maintain eye contact for 30 seconds — no other movement." },
    ...
    { emoji:"🩲", who:"any", target:"none", text:"Remove your bottoms and stay that way for the next three rounds." },
  ...
  extreme: [
    ...
    { emoji:"🖐️", who:"f", target:"mf",    text:"Finger yourself for 5 seconds and let {target} lick your fingers after." },
    ...
    { emoji:"🔥", who:"any", target:"mf",     text:"Grind against {target} with no clothing between you for 30 seconds." },
    ...
    { emoji:"💦", who:"any", target:"allF",    text:"Directly squeeze the breasts of {targets}." },
		{ emoji:"💦", who:"f", target:"allM",    text:"Put hand downs the pants and directly hold the balls of {targets} for 15 seconds each.  Did anyone get hard?" },
    // New dares batch 2
    { emoji:"🧊", who:"any", target:"any",     text:"Let {target} use an ice cube on any part of your body for 20 seconds." },
